{
  ...
  function intro() {
    ...
    document.querySelector(".projects").addEventListener("click", function() {
      ...
      document.querySelector(".links").insertAdjacentHTML('beforeend','<div id="div1"><li><span><a href="./Budgety/index.html">budgeting app</a></span></li><li><span><a href="./Pig-Game/index.html">pig-game</a></span></li><li><span><a>more coming soon...</a></span></li><li><span><a class="back">< back</a></span></li></div>');
